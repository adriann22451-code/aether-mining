...
const LEVEL_COST_GROWTH = 1.12;
const LEVEL_COST_BASE_RATIO = 0.08;

const PART_DATA: Record<string, { hp: number; buyCost: number }> = {
  gpu_0: { hp: 40e6, buyCost: 0 }, gpu_1: { hp: 180e6, buyCost: 2000 }, gpu_2: { hp: 750e6, buyCost: 9000 }, gpu_3: { hp: 3200e6, buyCost: 42000 }, gpu_4: { hp: 14000e6, buyCost: 190000 },
  rack_0: { hp: 10e6, buyCost: 0 }, rack_1: { hp: 45e6, buyCost: 1500 }, rack_2: { hp: 190e6, buyCost: 7000 }, rack_3: { hp: 800e6, buyCost: 32000 }, rack_4: { hp: 3400e6, buyCost: 150000 },
  cooling_0: { hp: 5e6, buyCost: 0 }, cooling_1: { hp: 22e6, buyCost: 1200 }, cooling_2: { hp: 95e6, buyCost: 5500 }, cooling_3: { hp: 400e6, buyCost: 26000 }, cooling_4: { hp: 1700e6, buyCost: 120000 },
  battery_0: { hp: 5e6, buyCost: 0 }, battery_1: { hp: 22e6, buyCost: 1200 }, battery_2: { hp: 95e6, buyCost: 5500 }, battery_3: { hp: 400e6, buyCost: 26000 }, battery_4: { hp: 1700e6, buyCost: 120000 },
  processor_0: { hp: 8e6, buyCost: 0 }, processor_1: { hp: 36e6, buyCost: 1800 }, processor_2: { hp: 150e6, buyCost: 8200 }, processor_3: { hp: 640e6, buyCost: 38000 }, processor_4: { hp: 2700e6, buyCost: 175000 },
  drone_0: { hp: 6e6, buyCost: 0 }, drone_1: { hp: 60e6, buyCost: 4000 }, drone_2: { hp: 500e6, buyCost: 60000 },
};
